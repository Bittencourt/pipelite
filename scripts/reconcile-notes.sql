...
--
-- NO SOFT-DELETE CARVE-OUT
--   The predicates below are character-for-character identical to the migration's
...
--   side of this file would make it report a false delta.
--
...
--   Byte mismatches: 0 for all four entity types.
-- =============================================================================
