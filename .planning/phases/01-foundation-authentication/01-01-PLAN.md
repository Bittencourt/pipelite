...
must_haves:
  ...
  artifacts:
    - path: "package.json"
      ...
      contains: "next-auth, drizzle-orm, argon2, nodemailer"
  ...
  <action>
    ...
    **Steps:**
    ...
    2. Install core dependencies:
       - `npm install next-auth@beta @auth/drizzle-adapter drizzle-orm drizzle-kit postgres argon2 nodemailer ioredis zod`
...
- All auth dependencies installed (next-auth@beta, drizzle-orm, argon2, nodemailer, zod, ioredis)
