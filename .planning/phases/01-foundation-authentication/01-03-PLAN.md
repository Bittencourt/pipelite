...
4. GET /api/verify-email transitions user to pending_approval
5. Signup form validates email and password (min 8 chars)
6. Verify email page handles waiting, loading, success, error states
</verification>
