...
- [x] 39-19-PLAN.md — D-39-01: browser proof that the organization advisory fires, and does not fire when it must not (runs LAST — owns the phase's only rebuild)
...
- [x] 40-10-PLAN.md — `SavedViewsBar`, and the V-40-5 parsed-interface gate
- [x] 40-11-PLAN.md — `/organizations` + `/people`: mount, redirect, escape, search resync
- [x] 40-12-PLAN.md — `/deals`: mount, redirect, escape, deleted-pipeline fallback
...
| 40. Saved Views & Shared Filters | 14/18 | In Progress|  |
